...
angular
  .module('ink')
  .factory('OperatorAPI', OperatorAPI)
 ...
 * @memberof services#
 * @example
 * var DailySpecialOffer = API('Event/DailySpecialOffer', {
 *   host: app.env.API,
 *   // 缓存, 默认关闭
 *   cache: false,
 ...
 * });
 */
function API($http, $cacheFactory, $q, app, param) {
  var _pt_, caches;

  _pt_   = CreateAPI.prototype;
  caches = {}; // API接口缓存集合, {API}.new 先从缓存里面取
